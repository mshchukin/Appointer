...
document.getElementById("managerImage").addEventListener("mouseover", hoverProfilePic);
document.getElementById("managerImage").addEventListener("mouseout", offhoverProfilePic);
